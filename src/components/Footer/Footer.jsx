      ...
      <footer className="bg-gray-900 py-8">
        <div className="container mx-auto flex flex-wrap justify-between">
          <div className="flex items-center justify-center">
            <img src="https://i.postimg.cc/Pf8YRMKQ/next.png" alt="Website Logo" className="h-8" />
            <span className="text-red-500 ml-2 font-bold text-lg"><sup>BD</sup></span>
          </div>
