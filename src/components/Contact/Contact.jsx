                ...
                <div className="grid md:grid-cols-2  mt-10 gap-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100">
                        ...
                        <div className="text-center border border-gray-200 p-2">
                            <div className="p-2">
                                <img src="https://i.ibb.co/h2K91vY/address.png" alt="" className="mx-auto w-8 mt-4" />
                            </div>
                            <h3 className="font-bold text-2xl py-2 text-[#243E63]">Address</h3>
                            <p className="w-3/4 mx-auto text-slate-950	 mb-3">
                        ...
                        {/* 2nd card */}
                        <div className="text-center border border-gray-200 p-2 bg-gray-100">
                            <div className="p-2">
                                <img src="https://i.ibb.co/mc4P5kX/call.png" alt="" className="mx-auto w-8 mt-4" />
                            </div>
                        ...
                        <div className="text-center border border-gray-200 p-2">
                            <div className="p-2">
                                <img src="https://i.ibb.co/JFbVHTh/location.png" alt="" className="mx-auto w-8 mt-4" />
                            </div>
                        ...
                        <div className="text-center border border-gray-200 p-2">
                            <div className="p-2">
                                <img src="https://i.ibb.co/tpLQXVn/time.png" alt="" className="mx-auto w-8 mt-4" />
                            </div>
