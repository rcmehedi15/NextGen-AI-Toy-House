...
const ToyDetails = () => {
    ...
    console.log(toyAllData);
    //single data find
    const { toyId } = useParams();
    console.log(toyId);
    // const findToySingleData = toyAllData.find(info => info._id == toyId)
    // find data destructing 
    const { _id, photo, toyName, sellerName, sellerEmail, subCategory, Price, Rating, availableQuantity, detailDescription } = toyAllData;
